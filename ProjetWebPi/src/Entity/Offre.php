 ...
 * @ORM\Table(name="offre", indexes={@ORM\Index(name="cincreateuroffre", columns={"cincreateuroffre"})})
 */
class Offre
{
    /**
     ...
     * @ORM\JoinColumns({
     *   @ORM\JoinColumn(name="cincreateuroffre", referencedColumnName="cin")
     * })
     */
    ...
    public function getCincreateuroffre(): ?User
    {
        return $this->cincreateuroffre;
    }

    public function setCincreateuroffre(?User $cincreateuroffre): self
    {
